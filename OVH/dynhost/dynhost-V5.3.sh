...
# Sur la machine qui exécute le script, un dossier OVH doit être créé dans /home
# En cas de problème si le script ne se lance pas ajouter le crontab suivant : */1 * * * * /home/<utilisateur>/OVH/dynhost.sh >>/home/<utilisateur>/OVH/test.log 2>&1
